...
for species_code in species_codes:
    ...
    x = 10**ts['kxmax_log10']/10**ts['g1_log10']
...
g = sns.violinplot(x='species_code', y='param', hue='Species', data=df,\
                   dodge=False)
g.set(xticklabels=[])
g.set(xlabel=None)
g.tick_params(bottom=False)
g.set_ylabel(ylabel='$k_{xmax}/L/g_1$')
g.set(ylim=(0, 55))
g.legend(title='Species', title_fontsize=25)
fig = g.get_figure()
fig.savefig('../../Figures/g1_kxmax.png', bbox_inches='tight')
