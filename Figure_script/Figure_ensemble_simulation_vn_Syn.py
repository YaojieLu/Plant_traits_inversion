...
# read files
df = pd.read_csv('../Results/ensemble_vn.csv', sep = '\t', index_col = 0)
...
plt.savefig('../Figures/Figure ensemble simulation vn Syn.png', bbox_inches = 'tight')
